    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="pt-14 pb-8">
        ...
        <SectionWrapper
          title="הזימונים שלי"
          titleAccent
          backgroundStyle={{ backgroundColor: "#7edc82" }}
          className="py-10"
        >
          <div
            className="relative overflow-hidden rounded-[24px] bg-white p-8 shadow-[0_4px_20px_rgba(0,0,0,0.08)]"
          >
            <span className="absolute right-0 top-0 rounded-bl-lg bg-[#5a3d7a] px-4 py-2.5 text-sm font-medium text-white">
              זימון קרוב
            </span>
            <div className="flex flex-row-reverse justify-between gap-2 pt-4">
              <div className="min-w-0 flex-1">
                <div className="mb-5 flex flex-row items-center justify-end gap-2.5 text-lg text-[#7edc82]">
                  <span className="flex gap-1">
                    <span className="size-2.5 rounded-full bg-[#7edc82]" />
                    <span className="size-2.5 rounded-full bg-[#7edc82]" />
                    <span className="size-2.5 rounded-full bg-[#7edc82]" />
                  </span>
                ...
                <div className="mb-4 flex w-full items-center justify-start gap-2.5">
                  <span className="h-7 w-0.5 shrink-0 rounded-full bg-[#7edc82]" aria-hidden />
                  <p className="text-2xl font-bold text-gray-900">השתלמות</p>
                </div>
                <p className="mt-4 flex flex-row-reverse items-center justify-end gap-2 text-lg text-gray-600">
                  <span>03.02.26 - 04.03.26</span>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="shrink-0 text-gray-500">
                ...
                <p className="mt-3 flex flex-row-reverse items-center justify-end gap-2 text-lg text-gray-600">
            ...
            <div className="-mx-8 -mb-8 mt-8 flex overflow-hidden rounded-b-[24px]">
              <div className="flex flex-1 items-center justify-center rounded-br-[24px] border-t border-gray-100 bg-[#FFF8E7] py-5 text-lg font-medium text-gray-900">
                בקשות מיוחדות
              </div>
              <div className="flex flex-1 items-center justify-center rounded-bl-[24px] bg-[#FDD835] py-5 text-lg font-medium text-gray-900">
                החזרי נסיעות
              </div>
            </div>
          </div>
        ...
        <SectionWrapper
          ...
          actionButtonClassName="bg-[#7edc82] text-black shrink-0 order-first"
          titleClassName="ms-6"
        >
          <div className="space-y-4">
            <Card>
              ...
              <p className="mt-3 flex flex-row-reverse items-center justify-end gap-2 text-sm font-medium text-[#7edc82]">
            ...
            <div className="relative overflow-hidden rounded-[20px] bg-[var(--accent-yellow)] p-5 shadow-[var(--card-shadow)]">
              ...
              <div className="relative flex flex-row-reverse items-center gap-4">
                ...
                <div className="flex h-16 w-20 shrink-0 items-center justify-center rounded-lg bg-white/60">
                  <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#7edc82" strokeWidth="1.5">
